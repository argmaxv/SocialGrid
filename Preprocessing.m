...
spm fmri, close all
base_dir = ProjSet.basepath;    % the base directory
data_dir = ProjSet.DATApath;    % neuroimg data directory 
dir_struct  = 'T1';                        %anatomical scan
dir_fm      = 'Fieldmap';
sess_prfx   = info.prefix.Run;      %EPI run: R1 R2 R3...
[name_subj, subjN]=CallSub_PS;
